...
ephys_features <- as.sparse(read.csv(file = "./results/csv_data_filtered/Organoid_ephys_data_dpc.csv", sep = ",",
    header = TRUE, row.names = 1))
...
write.csv(joint_meta,"./results/OrganoidRecordingPseudo.csv", row.names = TRUE)
```